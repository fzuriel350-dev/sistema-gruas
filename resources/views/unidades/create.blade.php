...
<input id="año" name="año" type="number" value="{{ old('año') }}" required>
...
<input id="numero_economico" name="numero_economico" type="text" value="{{ old('numero_economico') }}">
...
<input id="estado_emplacado" name="estado_emplacado" type="text" value="{{ old('estado_emplacado') }}">
...
<option value="">Seleccionar...</option>                        @foreach ($oficinas as $oficina)                            <option value="{{ $oficina->id }}" @selected(old('oficina_id') == $oficina->id)>{{ $oficina->nombre }}</option>                        @endforeach                    </select>
...
<input type="checkbox" name="activo" value="1" @checked(old('activo', true)) class="rounded border-gray-300">
