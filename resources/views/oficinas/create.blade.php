@extends('layouts.app')@section('title', 'Nueva Oficina')@section('content')<div class="max-w-2xl mx-auto">
<div class="card">
...
<div class="card-body">
<form method="POST" action="{{ route('oficinas.store') }}" class="form-grid">                @csrf                <div class="form-group">
...
<input id="estado" name="estado" type="text" value="{{ old('estado') }}">
...
<input id="encargado" name="encargado" type="text" value="{{ old('encargado') }}">
